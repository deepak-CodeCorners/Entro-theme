  ...
  <div class="container-fluid padding_left3">
    <div class="row display_boxflex">
      ...
      <div class="col-xl-7 col-lg-7 col-md-7 col-sm-12 border_right">
         <div class="upcomimg">
           <figure><img src="<?php echo get_template_directory_uri(); ?>/images/up.jpg" alt="#"/></figure>
        </div>
          </div>
  </div>
    </div>
        ...
        <div class="row">
          <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 margi_bott">
            <div class="Gallery_img">
              <figure><img src="<?php echo get_template_directory_uri(); ?>/images/Gallery1.jpg" alt="#"/></figure>
            </div>
            <div class="hover_box">
             
              <ul class="icon_hu">
                 <h3>Music night</h3>
                <li><a href="#"><img src="<?php echo get_template_directory_uri(); ?>/icon/h.png" alt="#"/></a></li>
                 <li><a href="#"><img src="<?php echo get_template_directory_uri(); ?>/icon/h.png" alt="#"/></a></li>
              </ul>
            </div>
          </div>
          <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 margi_bott">
            <div class="Gallery_img">
              <figure><img src="<?php echo get_template_directory_uri(); ?>/images/Gallery2.jpg" alt="#"/></figure>
            </div>
            <div class="hover_box">
          ...
          <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 margi_bott1">
            <div class="Gallery_img">
              <figure><img src="<?php echo get_template_directory_uri(); ?>/images/Gallery3.jpg" alt="#"/></figure>
            </div>
            <div class="hover_box">
          ...
          <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
            <div class="Gallery_img">
              <figure><img src="<?php echo get_template_directory_uri(); ?>/images/Gallery4.jpg" alt="#"/></figure>
            </div>
            <div class="hover_box">
